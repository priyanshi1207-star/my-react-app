...
import { ArrowLeftIcon, AwardIcon, BriefcaseIcon, ChevronLeft, ChevronRight, Download, EyeIcon, EyeOffIcon, FileTextIcon, FolderIcon, GraduationCapIcon, HeartIcon, LanguagesIcon, Share2Icon, SparklesIcon, UserIcon } from 'lucide-react'
          ...
          <div className='lg:col-span-7 max-lg:mt-6 sticky top-6 h-fit'>
            ...
            <div className='relative w-full'>
              ...
              justify-end gap-2'>
                ...
                <button onClick={changeResumeVisibility} className='flex ites-center p-2 px-4 gap-2 text-xs
