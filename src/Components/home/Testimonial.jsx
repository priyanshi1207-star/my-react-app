...
const Testimonial = () => {
  ...
  return (
    ...
    <div id='testimonials' className="flex flex-col items-center my-10 scroll-mt-12">
        ...
        <Title title="Don't Just Build Your Resume, Build Your Future" description="Hear what our users have to say about their experience creating professional resumes with our AI-powered tools. We're always looking for ways to improve. If you have any feedback, we'd love to hear it!"/>
    </div>
