        ...
        <div className="max-w-5xl mx-auto bg-white text-zinc-800 p-10">
            ...
            <div className="flex items-center gap-10 mb-12 border-b pb-10 border-zinc-100">
                ...
                <div className="flex flex-col">
                    ...
                    {/* FIXED: Changed .profession to .professional_title */}
            ...
            <div className="grid grid-cols-12 gap-12">
                            ...
                            <div className="space-y-6 text-sm">
                                {data.education.map((edu, index) => (
                                    <div key={index}>
                                        ...
                                        <p className="text-[10px] text-zinc-400 mt-1 uppercase">{formatDate(edu.graduation_date)}</p>
                                    </div>
                                ))}
                            </div>
                        </section>
                ...
                <main className="col-span-8">
                    ...
                    {/* FIXED: Changed .experience to .work_experience */}
